...
typedef struct{
    interrupt_priorty_t usart_tx_int_priority;
...
typedef struct{
    interrupt_priorty_t usart_rx_int_priority;
...
typedef struct{
    ...
    void (*USART_RxFramingErrorHandler)(void);
    void (*USART_RxOverrunErrorHandler)(void);
#if INTERRUPT_PRIORTY_LEVELS_ENABLE==INTERRUPT_FEATURE_ENABLE   
    interrupt_priorty_t priority;
#endif
#endif
